...
func isisRouteInstallConfig(t *testing.T, otg *ondatra.OTG) (gosnappi.Config, helpers.ExpectedState) {
	...
	dutPort1Isis.Advanced().SetAreaAddresses([]string{"490001"})
	...
	dutPort2Isis.Advanced().SetAreaAddresses([]string{"490001"})
